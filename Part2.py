...
conn = psy.connect("host=dtim.essi.upc.edu port=5432 dbname=dbmateojacome user=mateo.jacome password=****PASSWORD****")
cur = conn.cursor()
...
engine = sal.create_engine('postgresql://mateo.jacome:****PASSWORD****@dtim.essi.upc.edu:5432/dbmateojacome')
